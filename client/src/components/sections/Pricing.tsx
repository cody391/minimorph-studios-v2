...
const TIER_DEFAULTS: Tier[] = [
  ...
  },
  {
    ...
    description: "The sweet spot. More pages, a blog, monthly recommendations, and enough updates to keep things fresh.",
    highlight: true,
    badge: "Most Popular",
    features: [
      "Up to 10 pages",
...
const comparisonRows: FeatureRow[] = [
  ...
  { feature: "Monthly recommendations", starter: false, growth: true, pro: true },
