...
const GUIDE_SECTIONS: GuideSection[] = [
  ...
  },
  {
    ...
    details: [
      "ACCOUNTABILITY TIERS: Your tier is based on performance metrics — conversion rate, activity consistency, and revenue.",
      "TIERS & COMMISSION RATES:",
      "• Bronze (starting tier): 10% commission, full daily training required, standard lead assignment",
      "• Silver: 12% commission, reduced daily training, improved lead priority",
      "• Gold: 14% commission, minimal daily training, priority lead assignment",
      "• Platinum: 15% commission, daily training exempt, first pick on high-value leads, mentor status",
  ...
  },
  {
    ...
    details: [
      ...
      "MONTH 3: SCALING UP",
      "• Target Silver tier by maintaining consistent activity and improving conversion",
