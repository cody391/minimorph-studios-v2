...
const GUIDE_SECTIONS: GuideSection[] = [
  ...
  },
  {
    ...
    details: [
      ...
      "• Platinum: Exempt from mandatory daily training — mentor status",
    ],
    tips: [
  ...
  },
  {
    ...
    details: [
      ...
      "• Platinum: 15% commission — requires 12+ months + $12,000+/mo closed MRR; daily training exempt; mentor status; first pick on enterprise leads",
