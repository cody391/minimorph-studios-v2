...
const GUIDE_SECTIONS: GuideSection[] = [
  {
    ...
    details: [
      ...
      "Complete all 8 Academy modules and pass each quiz with 80% or higher to earn your Full Certification.",
    ...
    tips: [
      "Start with Module 1 (Product Mastery) — you need to know what you're selling inside and out.",
  ...
  },
  {
    ...
    summary: "8 comprehensive modules that transform you into a psychological selling machine.",
    details: [
      ...
      "Module 4: Objection Handling — The LAER framework (Listen, Acknowledge, Explore, Respond) for the Big 4 objections: price, timing, competitor, and trust.",
  ...
  },
  {
    ...
    summary: "Your morning routine — review coaching feedback and complete required training before starting work.",
    details: [
      ...
      "Critical and Important reviews MUST be completed before you can start your day.",
      "Each review includes: what happened, what you should have done differently, and a quick quiz to confirm understanding.",
      "As you rank up in the gamification system, daily training requirements decrease:",
      "• Rookie: Must complete ALL pending reviews (critical + important + suggested)",
      "• Closer: Must complete critical + important reviews",
      "• Ace: Must complete critical reviews only",
      "• Elite: No mandatory daily reviews (but still recommended)",
      "• Legend: No mandatory daily reviews",
    ],
    tips: [
  ...
  },
  {
    ...
    details: [
      ...
      "Commission rates are based on the service tier sold and any applicable bonuses.",
      "Bonuses are awarded for: hitting monthly targets, maintaining high conversion rates, and streak milestones.",
      "The gamification system awards points for every activity — calls, emails, deals closed, training completed.",
      "Points translate to levels: Rookie → Closer → Ace → Elite → Legend.",
      "Higher levels unlock perks: reduced training requirements, priority lead assignment, and higher commission tiers.",
    ],
    tips: [
  ...
  },
  {
    ...
    summary: "Level up, earn badges, compete on the leaderboard, and unlock real perks.",
    details: [
      "POINTS: Earned for every productive activity — calls, emails, deals, training, etc.",
      "LEVELS: Rookie (0-499) → Closer (500-1999) → Ace (2000-4999) → Elite (5000-14999) → Legend (15000+)",
      "BADGES: Special achievements like 'First Deal', 'Perfect Week', '10-Day Streak', 'Quiz Master', etc.",
      "STREAKS: Consecutive days of activity. Longer streaks = bigger point multipliers.",
      "LEADERBOARD: See how you rank against other reps. Top performers get highlighted.",
      "RANK PERKS:",
      "• Rookie: Full daily training required, standard lead assignment",
      "• Closer: Reduced training (skip suggested reviews), slightly better leads",
      "• Ace: Only critical reviews required daily, priority lead assignment",
      "• Elite: No mandatory daily training, first pick on high-value leads",
      "• Legend: All Elite perks + mentor status, highest commission tier",
    ],
    tips: [
      ...
      "Badge hunting is a great way to build diverse skills across all areas of the platform.",
    ],
  },
  {
    id: "ai-coaching",
