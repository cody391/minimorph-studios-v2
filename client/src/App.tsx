...
const AdminGovernance = lazy(() => import("./pages/admin/GovernancePanel"));
...
const AdminManualFulfillment = lazy(() => import("./pages/admin/ManualFulfillment"));
const AdminLegalVault = lazy(() => import("./pages/admin/LegalVault"));
...
function Router() {
  return (
    <Switch>
      ...
      <Route path="/become-rep/payout-setup">
        <LazyPage><PayoutSetup /></LazyPage>
      </Route>
      ...
      <Route path="/admin/fulfillment">
        <AdminPage><AdminManualFulfillment /></AdminPage>
      </Route>
      <Route path="/admin/legal">
        <AdminPage><AdminLegalVault /></AdminPage>
      </Route>
      ...
      <Route path="/admin/governance">
        <AdminPage><AdminGovernance /></AdminPage>
      </Route>
      <Route path="/admin/products">
        <AdminPage><AdminProducts /></AdminPage>
      </Route>
      <Route path="/admin/support">
        <AdminPage><AdminSupport /></AdminPage>
      </Route>
      <Route path="/admin/broadcasts">
        <AdminPage><AdminBroadcasts /></AdminPage>
      </Route>
      <Route path="/admin/sites">
        <AdminPage><AdminSites /></AdminPage>
      </Route>
      ...
      <Route path="/admin/human-review">
        <AdminPage><AdminHumanReview /></AdminPage>
      </Route>
